...
void Particle::Update(float dt)
{
	...
	pState.pLive.alpha = (pState.pLive.ageRatio * 255.0f);
...
void Particle::Draw()
{
	...
	App->render->BlitParticle(App->psystem->GetParticleAtlas(), pState.pLive.alpha, (int)centerX, (int)centerY, &pState.pLive.pRect, &pState.pLive.rectSize);
}
